...
/**
 * Пример простого класса, который позволяет выводить текущее состояние
 * различных регионов памяти, а также информацию о сборках мусора, его
 * можно взять за основу, если хотим разработать свой собственный мониторинг.
 */
