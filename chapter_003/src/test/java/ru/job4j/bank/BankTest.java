...
//    }
    ...
    public void whenDeleteUser1() {
        ...
        bank.addUser(petrov);
        bank.deleteUser(petrov);
        assertThat(bank.getUser1("1111-5678"), is(nullValue()));
    }

//    @Test
//    public void whenAddTwoAccountsToUser() {
//        User petrov = new User("Petrov", "1111-5678");
...
//    }
    ...
    public void whenAddTwoAccountsToUser1() {
        ...
        Account second = new Account("40-50-60", 2000);
        bank.addUser(petrov);
        bank.addAccountToUser1("1111-5678", first);
        bank.addAccountToUser1("1111-5678", second);
        List<Account> result = bank.getUserAccounts1("1111-5678");
        assertThat(result.size(), is(2));
    }
...
//    }
    ...
    public void whenDeleteAccountFromUser1() {
        ...
        bank.addAccountToUser1("1111-5678", first);
        bank.addAccountToUser1("1111-5678", second);
        bank.addAccountToUser1("1111-5678", third);
        List<Account> result = bank.getUserAccounts1("1111-5678");
        assertThat(result.size(), is(3));
        bank.deleteAccountFromUser1("1111-5678", first);
        result = bank.getUserAccounts1("1111-5678");
        assertThat(result.size(), is(2));
    }
...
//    }
    ...
    public void whenTransferMoney1() {
        ...
        bank.addAccountToUser1("1111-5678", first);
        bank.addAccountToUser1("1111-5678", second);
        bank.addAccountToUser1("2222-5678", third);
        boolean result = bank.transferMoney("1111-5678", "10-20-30", "2222-5678", "70-80-90", 300);

        List<Account> srcUserAccounts = bank.getUserAccounts1("1111-5678");
        List<Account> destUserAccounts = bank.getUserAccounts1("2222-5678");
...
//    @Test
//    public void whenTransferMoneyFromOneUsersAccountToAnother() {
//        User petrov = new User("Petrov", "1111-5678");
//        Account first = new Account("10-20-30", 1000);
//        Account second = new Account("40-50-60", 2000);
//        bank.addUser(petrov);
...
//    }
    ...
    public void whenTransferMoneyFromOneUsersAccountToAnother1() {
        ...
        List<Account> userAccounts = bank.getUserAccounts1("1111-5678");
